...
export const GET: RequestHandler = async ({ request }) => {
	...
	try {
		...
		// Build response.
		//
		// Only members, stewards and admins are published. Trial members are
		// people still finding their footing — the public list is a roster of the
		// community, not of everyone who has an account. Exited members are
		// excluded for the same reason, more strongly.
